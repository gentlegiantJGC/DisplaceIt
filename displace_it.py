...
def bake_active(context: bpy.types.Context, obj: bpy.types.Object, res: int):
...
def displace_obj(context: bpy.types.Context, obj: bpy.types.Object, res: int, inplace=False):
...
def displace_selected(context: bpy.types.Context, resolution: int, inplace=False):
    ...
    for obj in context.selected_objects:
        try:
            displace_obj(context, obj, resolution, inplace)
        except:
            traceback.print_exc()
